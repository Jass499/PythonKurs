...
try:
    dbcsv = open(quelldatei, "r")  # ist aus der Standardbibliothek builtins, Modul io
except OSError:
    print("Öffnen der Quelldatei ist fehlgeschlagen")
    sys.exit(0)

# Zieldatei erstellen/öffnen
# eine Datei zum schreiben öffnen!!
try:
    dbtxt = open(zieldatei, "w")  # ist aus der Standardbibliothek builtins, Modul io
except OSError:
    print("Öffnen der Zieldatei ist fehlgeschlagen")
    sys.exit(0)
